...
parcelRegister("dEEzi", function(module, exports) {

$parcel$export(module.exports, "ESP32H2ROM", () => $9f0e7ac9a25452b1$export$2184cd7dbcdab15a);

var $8ZpYL = parcelRequire("8ZpYL");

var $38jnX = parcelRequire("38jnX");
class $9f0e7ac9a25452b1$export$2184cd7dbcdab15a extends (0, $8ZpYL.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($38jnX))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($38jnX))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($38jnX))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($38jnX))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($38jnX))).text;
    }
...
parcelRegister("38jnX", function(module, exports) {
...
//# sourceMappingURL=esp32h2.2a1e7428.js.map
