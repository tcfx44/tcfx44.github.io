...
parcelRegister("1ZsMP", function(module, exports) {

$parcel$export(module.exports, "ESP32S3ROM", () => $1731d15f7f396fc5$export$e18277a04821a5e);

var $8ZpYL = parcelRequire("8ZpYL");

var $gSwjW = parcelRequire("gSwjW");
class $1731d15f7f396fc5$export$e18277a04821a5e extends (0, $8ZpYL.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($gSwjW))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($gSwjW))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($gSwjW))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($gSwjW))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($gSwjW))).text;
    }
...
parcelRegister("gSwjW", function(module, exports) {
...
//# sourceMappingURL=esp32s3.061ac1bb.js.map
