...
parcelRegister("hi4OS", function(module, exports) {

$parcel$export(module.exports, "ESP32H2ROM", () => $c967db2a69c19888$export$2184cd7dbcdab15a);

var $5Pd9Q = parcelRequire("5Pd9Q");

var $b3aEc = parcelRequire("b3aEc");
class $c967db2a69c19888$export$2184cd7dbcdab15a extends (0, $5Pd9Q.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($b3aEc))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($b3aEc))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($b3aEc))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($b3aEc))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($b3aEc))).text;
    }
    ...
    async _post_connect(loader) {
        ...
        if (buf_no == this.UARTDEV_BUF_NO_USB) loader.ESP_RAM_BLOCK = this.USB_RAM_BLOCK;
    }
...
parcelRegister("b3aEc", function(module, exports) {
...
//# sourceMappingURL=esp32h2.40503ca8.js.map
