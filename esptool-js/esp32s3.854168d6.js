...
parcelRegister("lX7el", function(module, exports) {

$parcel$export(module.exports, "ESP32S3ROM", () => $ffb4b773bfaf7f4c$export$e18277a04821a5e);

var $5Pd9Q = parcelRequire("5Pd9Q");

var $ezzzd = parcelRequire("ezzzd");
class $ffb4b773bfaf7f4c$export$e18277a04821a5e extends (0, $5Pd9Q.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($ezzzd))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($ezzzd))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($ezzzd))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($ezzzd))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($ezzzd))).text;
    }
...
parcelRegister("ezzzd", function(module, exports) {
...
//# sourceMappingURL=esp32s3.854168d6.js.map
