...
parcelRegister("bD0qP", function(module, exports) {

$parcel$export(module.exports, "ESP32C6ROM", () => $8773abf4eee2e173$export$652353697ef98b38);

var $8ZpYL = parcelRequire("8ZpYL");

var $bYVNt = parcelRequire("bYVNt");
class $8773abf4eee2e173$export$652353697ef98b38 extends (0, $8ZpYL.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($bYVNt))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($bYVNt))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($bYVNt))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($bYVNt))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($bYVNt))).text;
    }
...
parcelRegister("bYVNt", function(module, exports) {
...
//# sourceMappingURL=esp32c6.acaa14c0.js.map
