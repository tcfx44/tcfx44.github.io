...
parcelRegister("dWzk5", function(module, exports) {

$parcel$export(module.exports, "ESP8266ROM", () => $a26c178fd6ca62e8$export$b7173f2d596cb720);

var $5Pd9Q = parcelRequire("5Pd9Q");

var $fwhuT = parcelRequire("fwhuT");
class $a26c178fd6ca62e8$export$b7173f2d596cb720 extends (0, $5Pd9Q.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($fwhuT))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($fwhuT))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($fwhuT))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($fwhuT))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($fwhuT))).text;
    ...
    async get_chip_description(loader) {
        ...
        const is_8285 = (efuse0 & 16 | efuse3 & 65536) != 0; // One or the other efuse bit is set for ESP8285
    ...
    async get_crystal_freq(loader) {
        ...
        if (Math.abs(norm_xtal - ets_xtal) > 1) loader.info("WARNING: Detected crystal freq " + ets_xtal + "MHz is quite different to normalized freq " + norm_xtal + "MHz. Unsupported crystal in use?");
        return norm_xtal;
    }
    _d2h(d) {
...
parcelRegister("fwhuT", function(module, exports) {
...
//# sourceMappingURL=esp8266.592413d3.js.map
